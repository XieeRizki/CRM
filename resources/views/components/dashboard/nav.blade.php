...
<!-- Sidebar -->
<div id="sidebar" class="fixed left-0 top-0 h-full w-80 bg-white shadow-2xl z-40 sidebar closed flex flex-col">
    ...
    <div class="flex-shrink-0 p-6 bg-gray-50 border-t">
